...
Had to use `devtools` to load `metricminer` locally. This won't render just as. 
...
The method of loading the data this way takes much longer,  but the ITN dashboard only had 1/3 of the workshops due to slido changing the export file name.
...
ggsave("plots/itcr_annual_slido_confidence_dumbbell.png")
```
...
ggsave("plots/itcr_annual_slido_confidence_density.png")
```
...
ggsave("plots/itcr_annual_slido_recommendation.png")
```
